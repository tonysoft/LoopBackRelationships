...
PersistedModel.setup = function setupPersistedModel() {
  ...
  PersistedModel.metadata = function(cb) {
    var response = {}
    response.title = PersistedModel.definition.settings.friendlyName || PersistedModel.definition.settings.plural || PersistedModel.definition.settings.name;
    response.description = PersistedModel.definition.settings.description || '';
    response.properties = PersistedModel.definition.rawProperties;
      cb(null, response);
  };
  ...
  PersistedModel.remoteMethod(
      "metadata",
      {
          description: 'Get the Metadata for this Model...',
          accepts: [],
          returns: {
              arg: 'metadata', type: 'object', root: true, description: 'The Client can use this Metadata to do things like auto-generate forms...'
          },
          http: {verb: 'get'}
      }
  );
